      ...
      <div class="special-list">
        ...
        <div class="special__row special__row-top">
          ...
          <div class="special-col4">
            <div class="special-box special-box-sale" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/bg/sale-bg.png');">
        ...
        <div class="special__row">
          ...
          <div class="special-col8">
            <div class="special-box special-box-tomove" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/bg/tomove-bg.png');">
